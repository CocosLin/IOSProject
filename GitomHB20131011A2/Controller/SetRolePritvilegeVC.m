...
- (void)creatButtons{
    ...
    [option8 setTitle:@"修改部门名称" forState:UIControlStateNormal];
    ...
    [option13 setTitle:@"修改考勤配置" forState:UIControlStateNormal];
    ...
    [option4 setTitle:@"修改部门验证方式" forState:UIControlStateNormal];
    ...
    [option12 setTitle:@"删除员工" forState:UIControlStateNormal];
    ...
    [option6 setTitle:@"删除员工" forState:UIControlStateNormal];
    ...
    [option14 setTitle:@"删除员工" forState:UIControlStateNormal];
...
- (void)didSelectedCheckBox:(QCheckBox *)checkbox checked:(BOOL)checked {
    ...
    //comData.organization.operations
}
