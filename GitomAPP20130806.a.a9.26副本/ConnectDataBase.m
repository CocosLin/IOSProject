...
+(sqlite3 *)createDB{
    ...
    NSString *sourcePath=[[NSBundle mainBundle]pathForResource:@"Gitom_DataBase" ofType:@"sqlite"];
    //获取document目录路径  c函数返回数组
    NSString *docPath=[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES)objectAtIndex:0];
    //会以目录的形式 分割下字符串 带有分隔符/
    NSString *targetPath=[docPath stringByAppendingPathComponent:@"Gitom_DataBase.sqlite"];
