...
- (void)creatTextAndButtonView{
    ...
    but1.frame = CGRectMake(5, Screen_Height-114, Screen_Width/2-10, 50);
    ...
    but2.frame = CGRectMake(Screen_Width/2, Screen_Height-114, Screen_Width/2-10, 50);
