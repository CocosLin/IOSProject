...
typedef enum
{
    DB_TestTypeParamError,//参数错误
    DB_TestTypeParamVersionHigher,//SDK要求微博版本高于当前的
}DB_TestType;
...
+(BOOL) loginApp:(NSString *)appid secret:(NSString*)secret reserver:(NSString*)reserver testType:(DB_TestType)testType;
#endif
