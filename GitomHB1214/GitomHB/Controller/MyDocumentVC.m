...
- (void)saveUserDocumentAction{
    ...
    [hbKit saveUserDocumentWithUsername:comData.userModel.username
                            andRealName:nameEncod
                           andTelephone:_phoneNumber.text
                               andPhoto:self.headImgUrlStr];
...
//    if (_headImage) _headImage = nil;
//    if (_phoneNumber) _phoneNumber = nil;
    if (_unitName) _unitName = nil;
    if (_headImgUrlStr) _headImgUrlStr = nil;
    if (_imgdata) _imgdata = nil;
