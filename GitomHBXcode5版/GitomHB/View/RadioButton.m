...
-(void)defaultInit{
    ...
    [_button setImage:[UIImage imageNamed:@"checkbox_normal.png"] forState:UIControlStateNormal];
    [_button setImage:[UIImage imageNamed:@"checkbox_checked.png"] forState:UIControlStateSelected];
