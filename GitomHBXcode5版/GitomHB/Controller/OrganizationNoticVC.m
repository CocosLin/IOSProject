...
//    titleLabel.text = [self.textTitle stringByTrimmingCharactersInSet:set];
    ...
    NSString *imgUrlStr = [[NSString alloc]init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.timeLabel.text = [WTool getStrDateTimeWithDateTimeMS:messageMod.createDate  DateTimeStyle:@"yyyy-MM-dd HH:mm:ss"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HBServerKit *hbKit = [[HBServerKit alloc]init];
    [hbKit findReportWithOrganizationId:[messageMod.organizationId integerValue]
                              OrgunitId:[messageMod.orgunitId integerValue]
                            andReportId:messageMod.extend
                           getReportMod:^(ReportModel *reportMod) {
                               
        DetailQeryViewController *detailQeryView = [[DetailQeryViewController alloc]init];
        detailQeryView.reportModel = reportMod;
                               
                               NSLog(@"OrganizationNoticVC reportMod.reportType == %@",reportMod.reportType);
                               if ([reportMod.reportType isEqualToString:REPORT_TYPE_DAY_REPORT]) {
                                   detailQeryView.title = @"工作汇报详情";
                               }if ([reportMod.reportType isEqualToString:REPORT_TYPE_GO_OUT]) {
                                   detailQeryView.title = @"外出汇报详情";
                               }if ([reportMod.reportType isEqualToString:REPORT_TYPE_TRAVEL]) {
                                   detailQeryView.title = @"出差汇报详情";
                               }
                               
        NSLog(@"OrganizationNoticVC Time = %@,%@",[WTool getStrDateTimeWithDateTimeMS:reportMod.createDate DateTimeStyle:@"yyyy-MM-dd HH:mm:ss"],[WTool getStrDateTimeWithDateTimeMS:reportMod.updateDate DateTimeStyle:@"yyyy-MM-dd HH:mm:ss"]);
