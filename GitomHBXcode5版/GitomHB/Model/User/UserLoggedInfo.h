...
@property (nonatomic, copy) NSString *updatePosition;   //上传用户坐标时间间隔
@property (copy, nonatomic) NSString * appLevelCode;    //移动汇报等级：标准版或高级版
@property (nonatomic, copy) NSString *question;
@property (nonatomic, copy) NSString *answers;
@property (nonatomic, strong) NSArray *orgPropsArray;
