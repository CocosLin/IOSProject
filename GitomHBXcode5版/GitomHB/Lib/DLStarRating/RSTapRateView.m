  ...
  if (self) {
    ...
    [_oneStarButton setImage:[UIImage imageNamed:@"star_full.png"] forState:UIControlStateSelected];
      if ([[[UIDevice currentDevice] systemVersion] floatValue]<6.0){
          [_oneStarButton addTarget:self action:@selector(tapStarButton:) forControlEvents:UIControlEventTouchDown];
      }else{
    ...
    [_twoStarButton setImage:[UIImage imageNamed:@"star_full.png"] forState:UIControlStateSelected];
      if ([[[UIDevice currentDevice] systemVersion] floatValue]<6.0){
          [_twoStarButton addTarget:self action:@selector(tapStarButton:) forControlEvents:UIControlEventTouchDown];
      }else{
    ...
    [_threeStarButton setImage:[UIImage imageNamed:@"star_full.png"] forState:UIControlStateSelected];
      if ([[[UIDevice currentDevice] systemVersion] floatValue]<6.0){
          [_threeStarButton addTarget:self action:@selector(tapStarButton:) forControlEvents:UIControlEventTouchDown];
      }else{
    ...
    [_fourStarButton sizeToFit];
      if ([[[UIDevice currentDevice] systemVersion] floatValue]<6.0){
          [_fourStarButton addTarget:self action:@selector(tapStarButton:) forControlEvents:UIControlEventTouchDown];
      }else{
    ...
    [_fiveStarButton setImage:[UIImage imageNamed:@"star_full.png"] forState:UIControlStateSelected];
      if ([[[UIDevice currentDevice] systemVersion] floatValue]<6.0){
          [_fiveStarButton addTarget:self action:@selector(tapStarButton:) forControlEvents:UIControlEventTouchDown];
      }else{
