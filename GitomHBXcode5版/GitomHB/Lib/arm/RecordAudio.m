...
- (NSURL *) stopRecord {
    NSURL *url = nil;
    if (recorder.url.absoluteString) url =
...
//     nil];
    ...
    recordedTmpFile = [NSURL fileURLWithPath:[NSTemporaryDirectory() stringByAppendingPathComponent: [NSString stringWithFormat: @"%@.%@", @"soundRecord", @"caf"]]];
